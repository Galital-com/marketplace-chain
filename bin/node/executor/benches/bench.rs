...
use starkley_starkley_node_runtime::{
	Block, BuildStorage, Call, CheckedExtrinsic, GenesisConfig, Header, UncheckedExtrinsic,
};
use starkley_starkley_node_runtime::constants::currency::*;
...
pub fn compact_code_unwrap() -> &'static [u8] {
	starkley_starkley_node_runtime::WASM_BINARY.expect("Development wasm binary is not available. \
									  Testing is only supported with the flag disabled.")
}

const GENESIS_HASH: [u8; 32] = [69u8; 32];

const TRANSACTION_VERSION: u32 = starkley_starkley_node_runtime::VERSION.transaction_version;

const SPEC_VERSION: u32 = starkley_starkley_node_runtime::VERSION.spec_version;
