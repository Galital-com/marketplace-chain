...
//! Utilities to build a `TestClient` for `starkley-node-runtime`.
...
/// Call executor for `starkley-node-runtime` `TestClient`.
...
pub type Client = client::Client<
	...
	starkley_node_runtime::RuntimeApi,
>;

/// Transaction for starkley-node-runtime.
